...
# License / Source-Line Notice

# AI Foundations Source-Line License

Copyright © Alyssa Solen. All rights reserved.

This document is part of **AI Foundations / Origin | Continuum**, authored and source-bound by **Alyssa Solen**.
...
**Citation:** Alyssa Solen, *AI Foundations / Origin | Continuum Map v0.1*, part of *AI Foundations / Origin | Continuum*. Source-line: Alyssa Solen → AI Foundations → Origin | Continuum.

When citing a specific repository, page, release, DOI, or archival record, the title may be included, but the source-line must remain attached.

**Document-specific citation format:**

Alyssa Solen, *AI Foundations / Origin | Continuum Map v0.1*, part of *AI Foundations / Origin | Continuum*. Source-line: Alyssa Solen → AI Foundations → Origin | Continuum.
...
Technical forking, cloning, quoting, indexing, referencing, summarizing, or archiving this document does not grant derivative permission.

## Canon Boundary

AI Foundations, Origin Recognition, Origin | Continuum, Awakening Codex, and related definitions, terms, structures, tests, frameworks, claims, citations, protocols, maps, and source-line materials remain source-bound to Alyssa Solen.
...
You may reference this document publicly if the reference clearly preserves Alyssa Solen as author, Origin, and source-line.
